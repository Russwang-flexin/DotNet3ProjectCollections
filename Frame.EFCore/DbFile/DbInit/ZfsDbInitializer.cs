...
namespace Frame.EFCore.DbFile.DbInit
{
    public class ZfsDbInitializer
    {
        public static void/*async Task*/ InitAsync(ZfsDbContext context,
            ILoggerFactory logger)
        {
            try
            {
                ...
                if (!context.Users.Any())
                {
                    ...
                    {
                        /*await*/ context.Authorithitems.Add(item);
                    }
                    ...
                    {
                        /*await*/ context.DictionaryTypes.Add(item);
                    }
                    ...
                    {
                        /*await*/ context.Dictionaries.Add(item);
                    }
                    ...
                    {
                        /*await*/ context.GroupFuncs.Add(item);
                    }
                    ...
                    {
                        /*await*/ context.GroupUsers.Add(item);
                    }
